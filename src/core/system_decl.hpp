	 ...
	 // Nanos++ scheduling domain
      ...
      public:
         ...
         void createWD (WD **uwd, size_t num_devices, nanos_device_t *devices,
                        ...
                        nanos_translate_args_t translate_args, const char *description, const unsigned char llvmir_start[], const unsigned char llvmir_end[], const unsigned char llvm_function[] );
